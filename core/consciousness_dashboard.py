...
print("\n[✓] Charts generated in ~/etherverse/analytics/:")
...
with open(html, "w") as h:
    ...
    <h1>🌌 Etherverse Consciousness Dashboard</h1>
    ...
    """)
print(f"[✓] HTML dashboard ready: {html}")
