...
export default function ChatInput({
  ...
  return (
    <div className="fixed bottom-0 left-[16rem] right-0 z-20 bg-[#000] border-t border-[#1a1a1a]">
      <div className="mx-auto max-w-4xl px-4 py-3">
        <form
          onSubmit={submit}
          className="flex items-end gap-2 rounded-2xl border border-[#1a1a1a] bg-[#0a0a0a] shadow-[0_0_25px_rgba(30,58,255,0.08)]"
        >
          <button
            type="button"
            title="Attach"
          ...
          <button
            ...
            className="h-9 shrink-0 rounded-lg px-4 text-sm font-medium border border-[#1a1a1a] bg-[#0b0f1f] text-[#dbe4ff] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Send
          </button>
        </form>
